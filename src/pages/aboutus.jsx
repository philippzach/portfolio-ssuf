    ...
    <Wrapper style={{ paddingTop: '2rem' }}>
      ...
      <div className="containertitleabout mb6">
        ...
        <p style={{ lineHeight: '35px' }} className="mv4">
          We are a team of startup enthusiasts, product & technology people and top management consultants. We help our
          clients execute digital growth – from the first board discussion to the execution of M&A, corporate ventures
          or building a digital business unit as well as a startup.
        </p>
        <FlipCards />
      </div>
    </Wrapper>
