...
const AboutUs = ({ data }) => (
  <Layout>
    <Seo
      title='SWISS STARTUP FACTORY - About us'
      desc='The team of the Swiss Startup Factory consists smart experts with a diverse set of experiences and passion for the startup ecosystem.'
    />
    <Navbar />
    <Test>
    ...
    <Wrapper style={{ paddingTop: '2rem' }}>
      ...
      <div className='containertitleabout mb6'>
        ...
        <p style={{ lineHeight: '35px' }} className='mv4'>
          We are a team of startup enthusiasts, product & technology people and
          top management consultants. We help our clients execute digital growth
          – from the first board discussion to the execution of M&A, corporate
          ventures or building a digital business unit as well as a startup.
        </p>
        <FlipCards />
      </div>
    </Wrapper>
      ...
      <div className='paddingtabs'>
        ...
        <div className='tabrow'>
          ...
          <article className='center pa3 pa4-ns'>
            <div className='tc'>
              <Img
                fluid={data.about14.childImageSharp.fluid}
                className='br-100 dib '
                style={Profile}
                title=''
                alt=''
          ...
          <article className='center pa3 pa4-ns'>
            <div className='tc'>
              <Img
                ...
                alt=''
              />
              <h3 className='f5 mb2'>Sonam Bhuka</h3>
              <h4 className='f6 fw4 gray mt0'>
    ...
    <Wrapper style={{ paddingTop: '5em', paddingBottom: '3em' }}>
      ...
      <div className='containertitleabout mv6'>
        ...
        <p className='lh-copy'>
          Our mentor team consists experts from all fields with diverse
...
export const query = graphql`
  query {
    ...
    about4: file(relativePath: { eq: "images/sandra.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about12: file(relativePath: { eq: "images/simon.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about13: file(relativePath: { eq: "images/sonam.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about14: file(relativePath: { eq: "images/jeroen_herman.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about15: file(relativePath: { eq: "images/emanuele.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about16: file(relativePath: { eq: "images/sandra.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
