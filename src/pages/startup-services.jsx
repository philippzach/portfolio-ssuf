...
const InvestmentPortfolio = ({ data }) => (
  <Layout>
    <Seo
      title='SWISS STARTUP FACTORY- Startup Services'
      desc='Founding a Startup is enough work – check our 360 degree startup services, so you can focus on your core business.'
    />
    <Navbar />
    <Test>
    ...
    <Wrapper style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
      ...
      <div className='containertitle'>
        <h2 className='lh-title'>
          Founding a startup is difficult and you have enough work with winning
          clients, securing funding and improving your product.
        </h2>
        <Paragraph>
          Check our 360-degree startup services from our service platform so you
          can focus on the topics that matter the most.
        </Paragraph>
      </div>
    </Wrapper>
    <div
      ...
      <div className='w-100 w-60-ns pl3-ns flex items-center measure center'>
        <div className='pa4'>
          <h3 className='lh-copy white' style={{ fontWeight: '300' }}>
            We work transparently, which requires quality, empathy and fair
            prices.{' '}
          </h3>
        </div>
      </div>
    ...
    <Wrapper>
      <article className='cf mb6 mt6'>
        ...
        <div className='fl tl w-100 w-50-ns pa3-s pa3-m pl4-l'>
          ...
          <Paragraph className=' mt3'>
            We help startups create modern products. Whether you need a
            prototype or a complex application, we build products that live up
            to your customers’ needs by using latest software development
            techniques and working with local and remote team setups.
          </Paragraph>
      ...
      <article className='mobileview cf mb6 mt3'>
        <div className='fl w-100 w-50-ns tl pa3-s pa3-m ph4-l'>
          <h3>Accounting</h3>
          <p className='mt3'>
            We offer customised solutions for startups in the areas of:
          </p>
          ...
          <p className='lh-copy mt3'>
            Due to years of experience in accounting and our customization to
            startups, we are experts in the field of accounting services for
            young firms.
          </p>
      ...
      <article className='cf mb6 mt3'>
        ...
        <div className='fl tl w-100 w-50-ns pa3-s pa3-m pl4-l'>
          ...
          <Paragraph className='mt3'>
            We advise you on your communication strategy, conceptualize and
            create content tailored to your target group, growth hack and
            establish the public relation.
          </Paragraph>
