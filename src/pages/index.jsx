    ...
    return (
      <Layout>
        ...
        <HeroInner>
          ...
          <HeroText style={{ fontWeight: '600' }}>
            At Swiss Startup Factory Innovation meets execution.
          </HeroText>
        </HeroInner>
        <div className='line' />
        <Wrapper style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
          ...
          <div className='containertitle' style={{ color: '#00486C' }}>
            ...
            >
              Swiss Startup Factory is a venture builder for corporates and
              startups to innovate and accelerate the best new technologies.
            </h2>
            <p className='lh-copy'>
              We are the number one privately financed venture builder in
              Switzerland, operating since 2015. The Swiss Startup Factory
              provides a professional execution platform for corporates and
              startups and offers a dedicated business-driven process that
              brings innovation to market in a fast, lean and agile way.
            </p>
            <p className='lh-copy'>
              <b className='lh-copy'>
                At Swiss Startup Factory innovation meets execution – we unleash
          ...
          <div className='w-100 w-60-ns flex items-center measure center'>
            <div style={{ padding: '0 3rem' }}>
              ...
              <p className='white lh-copy'>
                Being close to startups is the core for the Swiss Startup
                Factory.
              </p>
              <p className='white lh-copy'>
                We constantly adapt our frameworks and apply them to building up
                successful and sustainable startups.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='startupscontainer'>
          <article className='shadow maxwstartups hover mw5 center br4 pa3 pa4-ns mv3 b--black-10 flex flex-column '>
            <a href='mailto:acceleration@ssuf.ch' className='flex flex-column'>
              ...
              <div>
                <p
                  className='lh-copy measure center f6 black-70 tc'
                  style={{ color: 'rgb(0, 71, 107)' }}
                >
                  Based on more than 4 years of experience we have designed a
                  completely new customized accelerator program that will enable
                  you and your team to live up to your potential.
                </p>
              </div>
          ...
          <article className='shadow maxwstartups hover mw5 center br4 pa3 pa4-ns mv3 b--black-10 flex flex-column '>
            <a className='flex flex-column' href='mailto:meetus@ssuf.ch'>
              ...
              <p
                className='lh-copy measure center f6 black-70 tc mb5-ns'
                style={{ color: 'rgb(0, 71, 107)' }}
              >
                30-minute meeting where you can pitch your idea, tell us about
                your challenges and ask for our feedback.
              </p>
              <div className='mv3 center'>
                <span className='buttonfactory mid-gray ttu b'>
                  Get in touch
                </span>
              </div>
            </a>
          ...
          <article className='shadow maxwstartups hover mw5 center br4 pa3 pa4-ns mv3 b--black-10 flex flex-column '>
            <Link className='flex flex-column' to='/pitch-training'>
              ...
              <p
                ...
                style={{ color: 'rgb(0, 71, 107)' }}
              >
                We help you improve your pitch and highlight which areas are
                important and should be in the spotlight in order to move your
                company forward.
              </p>
              <div className='mv3 center'>
        ...
        <div className='flex flex-column flex-row-ns mv4 background'>
          ...
          <div className='w-100 w-60-ns flex items-center measure center'>
            <div style={{ padding: '0 3rem', color: 'rgb(0, 71, 107)' }}>
              ...
              <p className=' lh-copy'>
                Our goal is to understand and evaluate our corporate client’s
                current strategic innovation roadmap and, based on our
                specialized skills, provide best advice on its execution. For
                corporates, we are the interface to innovation.
              </p>
              <p className='lh-copy'>
          ...
          <div className='row'>
            <article className='shadow maxwcorporates hover items-center center br4 pa3 pa4-ns mv3 b--black-10 flex flex-column '>
              ...
              >
                ...
                <div>
                  <p
                    className='lh-copy measure center f6 black-70 mb4-l tc'
                    style={{ color: 'rgb(0, 71, 107)' }}
                  >
                    We offer customized innovation and digital transformation
                    consulting services.
                  </p>
                </div>
              ...
              >
                ...
                <div>
                  <p
                    ...
                    style={{ color: 'rgb(0, 71, 107)' }}
                  >
                    Adjusting our accelerator program to the structure of the
                    corporate, we build up existing startup projects with or
              ...
              >
                ...
                <div className='mt4-l mb4-l'>
                  <p
                    ...
                    style={{ color: 'rgb(0, 71, 107)' }}
                  >
                    Building up a completely new business model or startup from
                    scratch - outside the existing corporate structures.
                  </p>
                </div>
                <div className='mv3 tc'>
                  <span className='buttonfactory mid-gray ttu b'>
            ...
            <article className='shadow maxwcorporates hover items-center center br4 pa3 pa4-ns mv3  b--black-10 flex flex-column '>
              ...
              >
                <div className='tc'>
                  <h3
                    className='f4 pt3'
                    style={{ color: 'rgb(0, 71, 107)', lineHeight: '25px' }}
                  >
                ...
                <div>
                  <p
                    ...
                    style={{ color: 'rgb(0, 71, 107)' }}
                  >
                    The Center for Corporate Venturing connects innovation
                    leaders – its members have access to educational events,
                    networking opportunities and a place to exchange ideas.
                  </p>
                </div>
                <div className='mv3 tc'>
                  <span className='buttonfactory mid-gray ttu b'>
        ...
        >
          <Wrapper>
            ...
            <p className='lh-copy tc pb4'>
              We develop strategic partnerships with companies and organizations
              that share important core and strategic startup goals and values.
              These partnerships comprise several areas expertise and execution,
              ultimately aiming at creating value for our partners, the Swiss
              startup ecosystem as well as the Swiss Startup Group.
            </p>
            <LogoSlider />
          </Wrapper>
        </div>
