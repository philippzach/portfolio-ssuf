...
class Index extends Component {
  render() {
    ...
    return (
      <Layout>
        <Seo title="SWISS STARTUP FACTORY" desc="Schnitzel. We inspire & enable people to build sustainable companies and unleash entrepreneurial potential. " banner={SocialBanner} />
          <Navbar />
          <Test> 
