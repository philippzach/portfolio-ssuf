        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              ...
              <dt className="f6 b mt2">You didn't know that about me</dt>
              <dd className="ml0 mb3">Silver in Swiss championship over 800m</dd>
            </dl>
            <dl className="lh-title mt0">
              ...
              <dt className="f6 b mt2">Always goes</dt>
              <dd className="ml0 mb3">Getting to grips with a changing environment</dd>
        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            ...
            <dl className="lh-title mt0">
              ...
              <dd className="ml0 mb3">The Art of Thinking Clearly, Rolf Dobelli</dd>
            </dl>
          </div>
          <span className="arrows" />
        </div>
