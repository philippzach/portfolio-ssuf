...
import Mailchimp from '../components/form-footer-hubspot';
        ...
        <StyledFooter>
            ...
            >
              <li className='listitem'>
                ...
                <ul className='list pl0 ma0 pt3 light-gray'>
                  <li>
                    <Link className='sublistitem' to='/accelerator-faq'>
                      FAQ
                    </Link>
                  </li>
                  <li>
                    <Link className='sublistitem' to='/blog'>
                      News
                    </Link>
                  </li>
                </ul>
              ...
              <li className='listitem'>
                <Link to='/startups'>
                  <span className='topmenu'>Startups</span>
                </Link>
                <ul className='list pl0 ma0 pt3 light-gray'>
                  <li>
                    <Link className='sublistitem' to='/startup-accelerator'>
                      Accelerator
                    </Link>
                  </li>
                  <li>
                    <Link className='sublistitem' to='/pitch-training'>
                      Pitch Training
                    </Link>
                  </li>
                  <li>
                    <Link className='sublistitem' to='/startup-services'>
                      Startup Services
                    </Link>
                  </li>
                  <li className=' mb0'>
                    <Link className='sublistitem' to='/investment'>
                      Investment
                    </Link>
                  </li>
                </ul>
              ...
              <li className='listitem'>
                <Link to='/corporates'>
                  <span className='topmenu'>Corporates</span>
                </Link>
                <ul className='list pl0 ma0 pt3 light-gray'>
                  <li>
                    <Link className='sublistitem' to='/corporate-acceleration'>
                      Corporate Accelerator
                    </Link>
                  </li>
                  <li>
                    <Link className='sublistitem' to='/company-building'>
                      Company Building
                    </Link>
                  </li>
                  <li>
              ...
              <li className='listitem'>
                <a
                  ...
                  rel='noreferrer noopener'
                >
                  <span className='topmenu'>Jobs</span>
                </a>
                <ul className='list pl0 ma0 pt3 light-gray'>
                  <li>
                    <Link className='sublistitem' to='/innovator-program'>
                      Innovator Program
                    </Link>
                  </li>
                  <li>
                    <Link className='sublistitem' to='/eir-program'>
          ...
          <div className='socialcontainer pa1'>
            ...
            <div className='pv3'>
              ...
              <a href='https://www.linkedin.com/company/9253684/'>
                <svg
                  className='socialicon'
                  xmlns='http://www.w3.org/2000/svg'
                  height='20px'
          ...
          <div className='container'>
            <p className='copyright'>
              <Link to='/imprint' className='impressum'>
                © {new Date().getFullYear()} Swiss Startup Factory
              </Link>
            </p>
          </div>
        </StyledFooter>
