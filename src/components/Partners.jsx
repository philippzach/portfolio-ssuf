...
import Academic9 from '../../static/logo_partner/lg-epfl.svg';
...
const Partner = () => (
  <>
    <div className='tc mv6'>
      ...
      <Paragraph>
        Together with Swiss academic institutions, we support entrepreneurial
        teaching to leverage prime-potential students and ideas outside of the
        classroom.
      </Paragraph>
      <Background>
        <Row>
          <Svg src={Academic1} alt='' />
          <Svg1 src={Academic9} alt='' />
          <Svg1 src={Academic5} alt='' />
        </Row>
        <Row>
          <Svg1 src={Academic6} alt='' style={{ padding: '2em' }} />
          <Svg src={Academic4} alt='' />
          <Svg src={Academic3} alt='' />
        </Row>
        <Row>
          <Svg1 src={Academic7} alt='' />
          <Svg1 src={Academic8} alt='' style={{ padding: '2em' }} />
    ...
    <div className='tc mv6'>
      ...
      <Paragraph style={{ maxWidth: '45em' }}>
        Vertical partners are forward-thinking companies looking to have access
        to top Swiss Startups and aiming to drive their industry innovation
        forward. Together we accelerate selected startups and collaborate on
